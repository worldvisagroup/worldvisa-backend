...
export async function listLeadOwners(_req: Request, res: Response): Promise<void> {
  try {
...
export async function getLeadOwnerByPhone(req: Request, res: Response): Promise<void> {
  try {
