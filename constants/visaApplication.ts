 ...
 */
export const VISA_APPLICATION_COUNTRIES = [
  'Aruba',
  'Australia',
  'Austria',
  'Azerbaijan',
...
export type VisaApplicationCountry = (typeof VISA_APPLICATION_COUNTRIES)[number];

const countrySet = new Set<string>(VISA_APPLICATION_COUNTRIES);

export function isVisaApplicationCountry(value: string): value is VisaApplicationCountry {
  return countrySet.has(value);
}

export const VISA_APPLICATION_STATUS_VALUES = [
...
export type VisaApplicationStatus = (typeof VISA_APPLICATION_STATUS_VALUES)[number];

const statusSet = new Set<string>(VISA_APPLICATION_STATUS_VALUES);

export function isVisaApplicationStatus(value: string): value is VisaApplicationStatus {
