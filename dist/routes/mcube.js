...
const validateMcubeApiToken_1 = require("../middleware/mcube/validateMcubeApiToken");
...
router.post('/calls/outbound', validateMcubeApiToken_1.validateMcubeApiToken, mcubeOutboundController_1.handleOutboundCall);
