...
exports.fetchLogoAsBase64 = fetchLogoAsBase64;
exports.groupByDay = groupByDay;
exports.buildActivityLogHtml = buildActivityLogHtml;
exports.generateActivityLogPdf = generateActivityLogPdf;
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
// eslint-disable-next-line @typescript-eslint/no-var-requires
const puppeteer = require('puppeteer-core');
const { getPuppeteerConfig } = require('../utils/puppeteer-config');
const logger = require('../utils/logger');
// ─── Logo Fetcher ─────────────────────────────────────────────────────────────
async function fetchLogoAsBase64() {
    try {
        const logoPath = path_1.default.join(__dirname, '..', 'Images', 'world-visa-logo.png');
        const buffer = fs_1.default.readFileSync(logoPath);
...
// ─── HTML Template ────────────────────────────────────────────────────────────
function buildRecordTypeBadge(recordType) {
...
function buildActivityLogHtml(params) {
...
async function generateActivityLogPdf(html) {
    let browser = null;
    try {
