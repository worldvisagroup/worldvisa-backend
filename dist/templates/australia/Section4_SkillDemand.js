    ...
    return (react_1.default.createElement("div", { className: "section page" },
        ...
        react_1.default.createElement("div", { style: { marginBottom: '20pt' } },
            ...
            react_1.default.createElement("p", { style: { fontSize: '12pt', color: '#4B5563', margin: '0 0 6pt 0' } },
                ...
                " ",
                (0, renderTextWithLinks_1.renderTextWithLinks)(data.primaryOccupationCode)),
            react_1.default.createElement("table", { style: { width: '100%', borderCollapse: 'collapse', fontSize: '12pt' } },
                ...
                react_1.default.createElement("tbody", null, data.skillMappingTable.map((row, index) => (react_1.default.createElement("tr", { key: index },
                    react_1.default.createElement("td", { style: { padding: '5pt 8pt', border: '1pt solid #E5E7EB', color: '#111827', fontWeight: 600, verticalAlign: 'top', background: index % 2 === 0 ? '#FFFFFF' : '#F8F9FB' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(row.skill)),
                    react_1.default.createElement("td", { style: { padding: '5pt 8pt', border: '1pt solid #E5E7EB', color: '#4B5563', verticalAlign: 'top', background: index % 2 === 0 ? '#FFFFFF' : '#F8F9FB' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(row.anzscoCategory)),
                    react_1.default.createElement("td", { style: { padding: '5pt 8pt', border: '1pt solid #E5E7EB', verticalAlign: 'top', background: index % 2 === 0 ? '#FFFFFF' : '#F8F9FB' } },
                        react_1.default.createElement("span", { style: {
                                ...
                                borderRadius: '2pt'
                            } }, (0, renderTextWithLinks_1.renderTextWithLinks)(row.demandLevel))))))))),
        react_1.default.createElement("div", { style: { marginBottom: '20pt' } },
            ...
            data.occupationLists.map((list, index) => (react_1.default.createElement("div", { key: index, style: {
                ...
                react_1.default.createElement("p", { style: { fontSize: '12pt', fontWeight: 600, color: '#111827', margin: '0 0 4pt 0' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(list.listName)),
                react_1.default.createElement("ul", { style: { fontSize: '12pt', color: '#4B5563', margin: 0, paddingLeft: '14pt' } }, list.occupations.map((occ, occIndex) => (react_1.default.createElement("li", { key: occIndex, style: { marginBottom: '2pt', lineHeight: '1.4' } },
                    react_1.default.createElement("strong", null, (0, renderTextWithLinks_1.renderTextWithLinks)(occ)))))))))),
        react_1.default.createElement("div", { style: { marginBottom: '20pt' } },
            ...
            react_1.default.createElement("table", { style: { width: '100%', borderCollapse: 'collapse', fontSize: '12pt' } },
                ...
                react_1.default.createElement("tbody", null, data.statePriorityLists.map((state, stateIndex) => (react_1.default.createElement("tr", { key: stateIndex },
                    react_1.default.createElement("td", { style: { padding: '5pt 8pt', border: '1pt solid #E5E7EB', color: '#111827', fontWeight: 600, background: stateIndex % 2 === 0 ? '#FFFFFF' : '#F8F9FB' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(state.state)),
                    react_1.default.createElement("td", { style: { padding: '5pt 8pt', border: '1pt solid #E5E7EB', color: '#4B5563', background: stateIndex % 2 === 0 ? '#FFFFFF' : '#F8F9FB' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(state.status)))))))),
        react_1.default.createElement("div", { style: { borderLeft: '3pt solid #1B2A4A', padding: '6pt 10pt', background: '#F8F9FB' } },
            react_1.default.createElement("p", { style: { margin: 0, fontSize: '12pt', color: '#4B5563', lineHeight: '1.5' } },
                ...
                " ",
                (0, renderTextWithLinks_1.renderTextWithLinks)(data.availabilityNote)))));
}
