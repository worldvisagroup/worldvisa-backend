    ...
    return (react_1.default.createElement("div", { className: "section page" },
        ...
        data.tiers.map((tier, tierIndex) => (react_1.default.createElement("div", { key: tierIndex, style: { marginBottom: '20pt', pageBreakInside: 'avoid' } },
            react_1.default.createElement("div", { style: { borderLeft: '3pt solid #1B2A4A', padding: '6pt 10pt', marginBottom: '6pt', background: '#F8F9FB' } },
                react_1.default.createElement("div", { style: { fontSize: '12pt', fontWeight: 700, color: '#111827' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(tier.tierName)),
                react_1.default.createElement("div", { style: { fontSize: '10pt', color: '#9CA3AF', marginTop: '2pt' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(tier.tierDescription))),
            react_1.default.createElement("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '6pt' } }, tier.companies.map((company, companyIndex) => (react_1.default.createElement("div", { key: companyIndex, style: { padding: '6pt 8pt', border: '0.5pt solid #E5E7EB', borderRadius: '3pt', background: '#FFFFFF', pageBreakInside: 'avoid' } },
                react_1.default.createElement("span", { style: { fontWeight: 600, color: '#1F2937', fontSize: '12pt', display: 'block', marginBottom: '2pt' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(company.name)),
                react_1.default.createElement("span", { style: { fontSize: '10pt', color: '#6B7280', background: '#F3F4F6', padding: '1pt 5pt', borderRadius: '2pt', display: 'inline-block', marginBottom: '3pt' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(company.location)),
                react_1.default.createElement("div", { style: { fontSize: '12pt', color: '#4B5563', marginTop: '2pt', lineHeight: '1.3' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(company.description))))))))),
        react_1.default.createElement("div", { style: { marginTop: '8pt' } },
            ...
            react_1.default.createElement("table", { style: { width: '100%', borderCollapse: 'collapse', fontSize: '12pt' } },
                react_1.default.createElement("tbody", null, [
                    ...
                    react_1.default.createElement("td", { style: { padding: '5pt 8pt', color: '#4B5563', borderBottom: '0.5pt solid #E5E7EB', lineHeight: '1.4' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(row.value))))))))));
}
