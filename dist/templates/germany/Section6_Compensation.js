        ...
        react_1.default.createElement("div", { style: { marginBottom: '20pt' } },
            ...
            react_1.default.createElement("table", { style: { width: '100%', borderCollapse: 'collapse', border: '0.5pt solid #E5E7EB' } },
                ...
                react_1.default.createElement("tbody", null, data.salaryRanges.map((salary, index) => (react_1.default.createElement("tr", { key: index, style: { background: index % 2 === 0 ? '#F8F9FB' : '#FFFFFF' } },
                    react_1.default.createElement("td", { style: tdStyle }, (0, renderTextWithLinks_1.renderTextWithLinks)(salary.level)),
                    react_1.default.createElement("td", { style: tdStyle }, (0, renderTextWithLinks_1.renderTextWithLinks)(salary.location)),
                    react_1.default.createElement("td", { style: tdStyle }, (0, renderTextWithLinks_1.renderTextWithLinks)(salary.eurAnnual)),
                    react_1.default.createElement("td", { style: tdStyle }, (0, renderTextWithLinks_1.renderTextWithLinks)(salary.inrEquivalent)))))))),
        react_1.default.createElement("div", { style: { marginBottom: '20pt' } },
            ...
            react_1.default.createElement("table", { style: { width: '100%', borderCollapse: 'collapse', border: '0.5pt solid #E5E7EB' } },
                ...
                react_1.default.createElement("tbody", null, data.cityComparison.map((comparison, index) => (react_1.default.createElement("tr", { key: index, style: { background: index % 2 === 0 ? '#F8F9FB' : '#FFFFFF' } },
                    react_1.default.createElement("td", { style: { ...tdStyle, fontWeight: 600, color: '#111827' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(comparison.factor)),
                    react_1.default.createElement("td", { style: tdStyle }, (0, renderTextWithLinks_1.renderTextWithLinks)(comparison.berlin)),
                    react_1.default.createElement("td", { style: tdStyle }, (0, renderTextWithLinks_1.renderTextWithLinks)(comparison.munich)),
                    react_1.default.createElement("td", { style: tdStyle }, (0, renderTextWithLinks_1.renderTextWithLinks)(comparison.frankfurt)),
                    react_1.default.createElement("td", { style: { ...tdStyle, fontWeight: 600, color: '#059669' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(comparison.winner))))))))));
}
