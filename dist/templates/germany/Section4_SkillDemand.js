        ...
        react_1.default.createElement("div", { style: { marginBottom: '20pt' } },
            ...
            react_1.default.createElement("table", { style: { width: '100%', borderCollapse: 'collapse', fontSize: '12pt' } },
                ...
                react_1.default.createElement("tbody", null, data.skillMapping.map((skill, index) => (react_1.default.createElement("tr", { key: index, style: { backgroundColor: index % 2 === 0 ? '#FFFFFF' : '#FAFAFA' } },
                    react_1.default.createElement("td", { style: { padding: '6pt 8pt', borderBottom: '0.5pt solid #E5E7EB', color: '#111827', fontWeight: 600 } }, (0, renderTextWithLinks_1.renderTextWithLinks)(skill.skill)),
                    react_1.default.createElement("td", { style: { padding: '6pt 8pt', borderBottom: '0.5pt solid #E5E7EB' } },
                        react_1.default.createElement("span", { style: {
                                ...
                                fontWeight: 600,
                                borderRadius: '3pt'
                            } }, (0, renderTextWithLinks_1.renderTextWithLinks)(skill.marketDemand))),
                    react_1.default.createElement("td", { style: { padding: '6pt 8pt', borderBottom: '0.5pt solid #E5E7EB', color: '#4B5563' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(skill.salaryImpact)),
                    react_1.default.createElement("td", { style: { padding: '6pt 8pt', borderBottom: '0.5pt solid #E5E7EB', color: '#4B5563' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(skill.shortageStatus)))))))),
        react_1.default.createElement("div", { style: { marginBottom: '20pt' } },
            ...
            react_1.default.createElement("p", { style: { fontSize: '12pt', fontWeight: 600, color: '#111827', marginTop: 0, marginBottom: '4pt' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(data.techShortage.description)),
            react_1.default.createElement("ul", { style: { margin: 0, paddingLeft: '14pt', marginBottom: '6pt' } }, data.techShortage.marketFacts.map((fact, index) => (react_1.default.createElement("li", { key: index, style: { fontSize: '12pt', color: '#4B5563', marginBottom: '3pt', lineHeight: 1.4 } }, (0, renderTextWithLinks_1.renderTextWithLinks)(fact))))),
            react_1.default.createElement("div", { style: { borderLeft: '3pt solid #059669', backgroundColor: '#F0FDF4', padding: '6pt 10pt' } },
                react_1.default.createElement("p", { style: { fontSize: '12pt', color: '#111827', margin: 0 } },
                    ...
                    " ",
                    react_1.default.createElement("span", { style: { color: '#4B5563' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(data.techShortage.conclusion))))),
        react_1.default.createElement("div", { style: { marginBottom: '20pt' } },
            ...
            react_1.default.createElement("table", { style: { width: '100%', borderCollapse: 'collapse', fontSize: '12pt' } },
                ...
                react_1.default.createElement("tbody", null, data.demandByCity.map((city, index) => (react_1.default.createElement("tr", { key: index, style: { backgroundColor: index % 2 === 0 ? '#FFFFFF' : '#FAFAFA' } },
                    react_1.default.createElement("td", { style: { padding: '6pt 8pt', borderBottom: '0.5pt solid #E5E7EB', color: '#111827', fontWeight: 600 } }, (0, renderTextWithLinks_1.renderTextWithLinks)(city.city)),
                    react_1.default.createElement("td", { style: { padding: '6pt 8pt', borderBottom: '0.5pt solid #E5E7EB', color: '#4B5563' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(city.techMarket)),
                    react_1.default.createElement("td", { style: { padding: '6pt 8pt', borderBottom: '0.5pt solid #E5E7EB', color: '#4B5563' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(city.jobOpportunities)),
                    react_1.default.createElement("td", { style: { padding: '6pt 8pt', borderBottom: '0.5pt solid #E5E7EB', color: '#4B5563' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(city.salaryRange)),
                    react_1.default.createElement("td", { style: { padding: '6pt 8pt', borderBottom: '0.5pt solid #E5E7EB', color: '#4B5563' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(city.type))))))))));
}
