    ...
    return (react_1.default.createElement("div", { className: "section page" },
        ...
        react_1.default.createElement("div", { style: { marginBottom: '20pt' } },
            ...
            data.cities.map((city, index) => (react_1.default.createElement("div", { key: index, style: { marginBottom: '8pt' } },
                data.cities.length > 1 && (react_1.default.createElement("div", { style: { fontSize: '12pt', fontWeight: 600, color: '#1B2A4A', marginBottom: '3pt' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(city.city))),
                react_1.default.createElement("table", { style: { width: '100%', borderCollapse: 'collapse', fontSize: '12pt' } },
                    ...
                    react_1.default.createElement("tbody", null, city.factors.map((factor, i) => (react_1.default.createElement("tr", { key: i, style: { background: i % 2 === 0 ? '#FFFFFF' : '#F8F9FB' } },
                        react_1.default.createElement("td", { style: { ...tdStyle, fontWeight: 600, color: '#111827' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(factor.factor)),
                        react_1.default.createElement("td", { style: tdStyle }, (0, renderTextWithLinks_1.renderTextWithLinks)(factor.toronto)),
                        react_1.default.createElement("td", { style: tdStyle }, (0, renderTextWithLinks_1.renderTextWithLinks)(factor.vancouver)),
                        react_1.default.createElement("td", { style: tdStyle }, (0, renderTextWithLinks_1.renderTextWithLinks)(factor.montreal)),
                        react_1.default.createElement("td", { style: { ...tdStyle, fontWeight: 600, color: '#059669' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(factor.winner))))))))))),
        react_1.default.createElement("div", { style: { marginBottom: '20pt' } },
            ...
            react_1.default.createElement("table", { style: { width: '100%', borderCollapse: 'collapse', fontSize: '12pt' } },
                ...
                react_1.default.createElement("tbody", null, data.recommendation.priorities.map((priority, i) => (react_1.default.createElement("tr", { key: i, style: { background: i % 2 === 0 ? '#FFFFFF' : '#F8F9FB' } },
                    react_1.default.createElement("td", { style: { ...tdStyle, fontWeight: 600, color: '#111827' } }, (0, renderTextWithLinks_1.renderTextWithLinks)(priority.priority)),
                    react_1.default.createElement("td", { style: tdStyle }, (0, renderTextWithLinks_1.renderTextWithLinks)(priority.toronto)),
                    react_1.default.createElement("td", { style: tdStyle }, (0, renderTextWithLinks_1.renderTextWithLinks)(priority.vancouver)),
                    react_1.default.createElement("td", { style: tdStyle }, (0, renderTextWithLinks_1.renderTextWithLinks)(priority.montreal))))))))));
}
