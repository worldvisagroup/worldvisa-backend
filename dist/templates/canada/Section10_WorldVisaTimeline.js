...
function Section10_WorldVisaTimeline() {
    ...
    return (react_1.default.createElement("div", { className: "section page" },
        ...
        react_1.default.createElement("p", { style: { fontSize: '12pt', color: '#4B5563', marginBottom: '20pt', lineHeight: '1.5', marginTop: 0 } }, "Your step-by-step journey to Canadian permanent residency with WorldVisa's comprehensive support."),
