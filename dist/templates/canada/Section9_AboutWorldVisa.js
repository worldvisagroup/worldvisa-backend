...
exports.Section9_AboutWorldVisa = Section9_AboutWorldVisa;
    ...
    return (react_1.default.createElement("div", { className: "section page" },
        ...
        react_1.default.createElement("div", { style: { marginBottom: '20pt' } },
            ...
            react_1.default.createElement("div", { style: { borderLeft: '3pt solid #1B2A4A', padding: '8pt 10pt', background: '#F8F9FB' } },
                ...
                react_1.default.createElement("ul", { style: { margin: 0, paddingLeft: '14pt', fontSize: '12pt', color: '#4B5563', lineHeight: '1.4' } },
                    react_1.default.createElement("li", { style: { marginBottom: '2pt' } }, "Express Entry profile creation and optimization"),
                    react_1.default.createElement("li", { style: { marginBottom: '2pt' } }, "Provincial Nominee Program applications (BC PNP, OINP, AAIP)"),
                    react_1.default.createElement("li", { style: { marginBottom: '2pt' } }, "Educational Credential Assessment (ECA) coordination"),
                    react_1.default.createElement("li", { style: { marginBottom: '2pt' } }, "Language test preparation guidance (IELTS/PTE/CELPIP)"),
        ...
        react_1.default.createElement("div", { style: { marginBottom: '20pt' } },
            ...
            react_1.default.createElement("div", { style: { borderLeft: '3pt solid #1B2A4A', padding: '8pt 10pt', background: '#F8F9FB' } },
                ...
                react_1.default.createElement("ul", { style: { margin: 0, paddingLeft: '14pt', fontSize: '12pt', color: '#4B5563', lineHeight: '1.4' } },
                    react_1.default.createElement("li", { style: { marginBottom: '2pt' } }, "Employer-Specific Work Permits (LMIA-based)"),
                    react_1.default.createElement("li", { style: { marginBottom: '2pt' } }, "Global Talent Stream applications (2-week processing)"),
                    react_1.default.createElement("li", { style: { marginBottom: '2pt' } }, "Open Work Permits (Post-Graduation Work Permit style)"),
                    react_1.default.createElement("li", { style: { marginBottom: '2pt' } }, "Intra-Company Transfer Work Permits"),
                    react_1.default.createElement("li", null, "CUSMA/NAFTA professional work permits")),
                react_1.default.createElement("p", { style: { fontSize: '12pt', color: '#4B5563', marginTop: '6pt', marginBottom: 0, lineHeight: '1.5' } }, "Our team coordinates with Canadian employers, handles Labour Market Impact Assessment (LMIA) applications where required, and ensures compliance with all immigration regulations. Work permits can serve as a bridge to permanent residency through Canadian work experience points in Express Entry.")))));
}
