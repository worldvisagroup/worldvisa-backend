 ...
 *
 */
const validateHmacSignature = (payload, receivedSignature, secret) => {
  try {
    if (!secret) {
...
// Zoho-specific names kept as thin wrappers -- existing call sites are unchanged.
const generateZohoSignature = generateHmacSignature;
const validateZohoSignature = validateHmacSignature;
